              ...
              child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        child: Text('#${prompt.number}',
                          style: const TextStyle(
                            color: kAccent2, fontSize: 10.5,
                            fontWeight: FontWeight.w700, fontFamily: 'Courier')),
                      ),
                      const SizedBox(width: 8),
                      if (timeStr.isNotEmpty)
                        Text(timeStr, style: const TextStyle(color: kMuted, fontSize: 10.5)),
                      const Spacer(),
                      // Status badge
                      Container(
                  ...
                  if (prompt.text.isNotEmpty) ...[
                    ...
                    Text(
                      prompt.text.length > 160 ? '${prompt.text.substring(0, 160)}…' : prompt.text,
                  ...
                  if (prompt.attachments.isNotEmpty) ...[
                    ...
                    Wrap(
                      spacing: 6,
                      children: prompt.attachments.map((a) => Container(
                        padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
                        decoration: BoxDecoration(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              a.type == 'image' ? Icons.image_outlined
                              : a.type == 'audio' ? Icons.audiotrack_outlined
                              : Icons.attach_file,
    ...
    void _showDetail(BuildContext context) {
      showModalBottomSheet(
        ...
        builder: (_) => DraggableScrollableSheet(
          ...
          maxChildSize: 0.92,
          minChildSize: 0.3,
          builder: (_, ctrl) => _PromptDetailSheet(prompt: prompt, scrollCtrl: ctrl),
        ),
      );
    }
  }

  class _PromptDetailSheet extends StatelessWidget {
    final AgentPrompt prompt;
    final ScrollController scrollCtrl;
    const _PromptDetailSheet({required this.prompt, required this.scrollCtrl});
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: kAccent.withOpacity(0.12), borderRadius: BorderRadius.circular(7)),
                ...
                if (prompt.attachments.isNotEmpty) ...[
                  const Text('Pièces jointes', style: TextStyle(color: kMuted, fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 0.08)),
                  ...
                  ...prompt.attachments.map((a) {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Icon(a.type == 'audio' ? Icons.audiotrack_outlined : Icons.attach_file,
